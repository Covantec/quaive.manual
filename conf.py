# -*- coding: utf-8 -*-
#
# Quaive Manual documentation build configuration file, created by
# sphinx-quickstart on Fri Nov 25 23:00:59 2016.
#
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'lib', 'local']
...
#
# html_title = u'Quaive Manual v2.0'
...
htmlhelp_basename = 'QuaiveManualdoc'
...
latex_documents = [
    (master_doc, 'QuaiveManual.tex', u'Quaive Manual Documentation',
     u'Quaive.com', 'manual'),
]
...
man_pages = [
    (master_doc, 'quaivemanual', u'Quaive Manual Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'QuaiveManual', u'Quaive Manual Documentation',
     author, 'QuaiveManual', 'One line description of project.',
     'Miscellaneous'),
]
